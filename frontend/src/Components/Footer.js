         ...
         <Row>
            ...
            <Col className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 text-light">
               <h5 className="text-uppercase fw-bold mb-4 mt-3 text-light">
                  ...
                  <p><i className="bi bi-telephone-fill px-0 me-2"></i>832 513 0566</p>
                  <p><i className="bi bi-envelope-fill px-0 me-2"></i>quachthientai@gmail.com</p>
                  <p><i className="bi bi-star-fill px-0 me-2"></i>Give FeedBack</p>
            </Col>
         </Row>
